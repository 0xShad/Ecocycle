  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> userSearchUsersRecordList = snapshot.data!;
                  ...
                  if (!FFAppState().searchisactive)
                    Expanded(
                      child: Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final uservariable = userSearchUsersRecordList
                                .toList()
                                .take(15)
                                .toList();
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(12.0, 0.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      '${uservariableItem.firstname} ${uservariableItem.lastname}',
                  ...
                  if (FFAppState().searchisactive)
                    Expanded(
                      child: Padding(
                        ...
                        child: Builder(
                          builder: (context) {
                            final uservariable = _model.simpleSearchResults
                                .toList()
                                .take(15)
                                .toList();
