                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                              SubmittedCraftsWidget.routeName);
                                        },
                                        child: Row(
                                          mainAxisSize: MainAxisSize.max,
                                          mainAxisAlignment:
                                          ...
                                          children: [
                                            ...
                                            FutureBuilder<
                                              ...
                                              future:
                                                  queryCraftSubmissionRecordOnce(
                                                queryBuilder:
                                                    (craftSubmissionRecord) =>
                                                        craftSubmissionRecord
                                                            .where(
                                                  'submit_by',
                                                  isEqualTo:
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          context.pushNamed(
                                              SavedVideosPageWidget.routeName);
                                        },
                                        child: Row(
                                          mainAxisSize: MainAxisSize.max,
                                          mainAxisAlignment:
                          ...
                          children: [
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  context
                                      .pushNamed(SubmitCraftWidget.routeName);
                                },
                                text: 'Submit upcycle craft',
                                icon: Icon(
                                  Icons.file_upload,
                            ...
                            if (valueOrDefault<bool>(
                                    currentUserDocument?.userIsAdmin, false) ==
                                true)
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    10.0, 10.0, 10.0, 0.0),
            ...
            child: Column(
              ...
              children: [
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              await currentUserReference!
                                ...
                                backgroundPic: _model.uploadedFileUrl,
                              ));
                            },
                            child: Icon(
                              Icons.image,
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                      FollowingAndFollowersWidget.routeName);
                                },
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Container(
                        ...
                        child: Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final userworrks = containerUserWorksRecord?.works
                                      .map((e) => e)
                                      .toList()
                                      .toList() ??
                                  [];
                              ...
                              return Container(
                                ...
                                child: CarouselSlider.builder(
                                  itemCount: userworrks.length,
                                  itemBuilder: (context, userworrksIndex, _) {
                                    final userworrksItem =
                                        userworrks[userworrksIndex];
                                    return ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: Image.network(
                                        userworrksItem,
                                  ...
                                  options: CarouselOptions(
                                    initialPage:
                                        max(0, min(1, userworrks.length - 1)),
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(12.0, 12.0, 0.0, 15.0),
                    child: Text(
                      'Activity',
